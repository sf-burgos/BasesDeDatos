...
insert into Contenido values (N'Sebastian Nieto', date'2019-03-06', N'sebas.rechonchito.com', N'F', N'python',N'Codigo');
insert into Contenido values (N'Brayan Burgos', date'2019-03-06', N'sf.burgos.com',N'V', N'java',N'logica');
insert into Contenido values (N'Paula Guevara',date'2019-03-06',N'paula.geuvara.com',N'V',N'scratch',N'bases');
